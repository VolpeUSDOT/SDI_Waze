...
```
sudo yum --enablerepo=epel install gdal proj proj-devel
...
ldconfig
```
Do not have permission to write to /etc/ld.so.conf.d/
...
```
export LD_LIBRARY_PATH="/home/ec2-user/gdal-2.2.3/lib:$LD_LIBRARY_PATH"
