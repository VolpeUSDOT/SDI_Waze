...
For binary and continuous models, mean squared error is simply the mean squared difference between observed and estimated values (the residual error).  
...
Diag.frame <- vector()
for(i in c("01", "04", "06")){
  Diag.frame <- rbind(Diag.frame, c(keyoutputs1[[i]][[3]]))
 }
