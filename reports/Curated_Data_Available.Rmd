...
for(state in use.states){
  ...
  for(i in find.months){ # i = "01"; state = "DC"
    ...
    size_cmd = paste0('aws s3 ls s3://prod-dot-sdc-curated-911061262852-us-east-1/waze/version=20180720/content/state=', state ,'/table=alert/projection=redshift/year=2018/month=', i, "/ --recursive --summarize")
...
df$Value = paste(df$Days, df$Size.h, df$Objects, sep = " \t")
