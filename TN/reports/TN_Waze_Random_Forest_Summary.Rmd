...
tn.files <-  c(
  'TN_Model_01_TN_01dd_fishnet_RandomForest_Output.RData',
  'TN_Model_02_TN_01dd_fishnet_RandomForest_Output.RData',
  'TN_Model_03_TN_01dd_fishnet_RandomForest_Output.RData',
  ...
  'TN_Model_01_TN_1sqmile_hexagons_RandomForest_Output.RData',
  'TN_Model_02_TN_1sqmile_hexagons_RandomForest_Output.RData',
  'TN_Model_03_TN_1sqmile_hexagons_RandomForest_Output.RData',
...
# Matching Waze accidents as response
...
- `MatchTN_buffer_Acc` as response variable in the model.
...
The first level (no Waze), has the following variables, below. The weather variables are mean values within a grid cell, from a spatial interpolation of daily weather station data. See Word document on data preparation for more details. These weather variables are not yet prepared for the 1 sq mile hexagon layer.
...
datatable(tabl, 
          caption = "`MatchTN_buffer_Acc`, Tennessee 0.1 decimal degree Hourly model comparisons",
          rownames = T,
          options = list(dom = "t",
...
rownames(tabl) =  c("No Waze", "Base Waze", "All Waze")
datatable(tabl, 
          caption = "`MatchTN_buffer_Acc`, Tennessee 1 square mile hexagons Hourly model comparisons",
          rownames = T,
          options = list(dom = "t",
                         order = list(list(5, 'desc')),
                         pageLength = 5)
...
load(file.path(outputdir, "TN_Model_01_TN_01dd_fishnet_RandomForest_Output.RData"))
dd_01_rf.out = rf.out

load(file.path(outputdir, "TN_Model_03_TN_01dd_fishnet_RandomForest_Output.RData"))
dd_03_rf.out = rf.out
...
datatable(All_imp,
          rownames = FALSE,
          colnames = c("Variable", "dd 01 Rank", "dd 01 Imp",
                       "dd 03 Rank", "dd 03 Imp",
                       "hex 01 Rank", "hex 01 Imp",
                       "hex 03 Rank", "hex 03 Imp"),
          caption = "`MatchTN_buffer_Acc`, Importance of variables for the two grid sizes and two of the levels of Waze data",
...
load(file.path(outputdir, "TN_Model_06_TN_01dd_fishnet_RandomForest_Output.RData"))
dd_03_rf.out = rf.out

load(file.path(outputdir, "TN_Model_04_TN_1sqmile_hexagons_RandomForest_Output.RData"))
hex_01_rf.out = rf.out

load(file.path(outputdir, "TN_Model_06_TN_1sqmile_hexagons_RandomForest_Output.RData"))
hex_03_rf.out = rf.out
...
datatable(All_imp,
          ...
          colnames = c("Variable", "dd 04 Rank", "dd 04 Imp",
                       "dd 06 Rank", "dd 06 Imp",
                       "hex 04 Rank", "hex 04 Imp",
                       "hex 06 Rank", "hex 06 Imp"),
