...
source2("SpecialEventsAnalysis.R", 172, 210) # Data process
...
plotMonth <- function(dt, loc, weekday, statistic, metrics){
        ...
        dt_Date <- if (statistic == "Total") sumfun(dt, weekday) else if (statistic == "Average") meanfun(dt, weekday) else maxfun(dt, weekday)
...
plotMonth(dt, loc, weekday, statistic, metrics)
...
plotDate(dt, loc, weekday, statistic, metrics)
