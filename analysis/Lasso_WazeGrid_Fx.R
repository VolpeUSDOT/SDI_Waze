# Lasso functions for Waze
require(pROC)
######################################################################
# do.lr function for running lasso regression models in parallel ----
...
# formula - If provided, use this formula instead of the automatically generated one for the lasso regression model
...
# lr.inputs - list of arguments to pass to glmnet
...
do.lr <- function(train.dat, omits, response.var = "MatchEDT_buffer_Acc", model.no,
