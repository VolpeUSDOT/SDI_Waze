...
# [1] 71630 # remove missing street observations and filter on street (in sequence)
...
## Time comparison between accidents and all other points
...
## after accidents
hist(as.numeric(lapply(final.list.post, nrow)), breaks ="scott")

## before accidents (antecedent events)
hist(as.numeric(lapply(final.list, nrow)),  breaks = "scott")
