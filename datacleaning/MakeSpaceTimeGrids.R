...
for(j in todo.months){ # j="04"
  ...
  #Make data frame of all Grid IDs by day of year and time of day in each month of data (subet to all grid IDs with Waze OR EDT data)
...
movefiles(dir(temp.outputdir)[grep("Hex", dir(temp.outputdir))], temp.outputdir, outputdir)
    ...
    #Read in the waze.hex.time file 
