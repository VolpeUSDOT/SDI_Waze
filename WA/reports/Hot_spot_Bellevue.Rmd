...
Hot spot of compiled Waze events from April 2017 to November 2018 in Bellevue, WA.
Events within 6 miles of the center of Bellevue were included in this initial work; one of the next steps will be to clip to the city boundary shapfile. In addition, the Bellevue road network has not yet been incorporated in these maps. A base layer derived from Open Street Maps is used for these maps.
...
if(length(grep("^WA_Bellevue_Prep.RData$", dir(file.path(localdir, "WA"))))==0){ # do prep loop if needed
...
system(paste(
  ...
  load(file.path(localdir, "WA", "WA_Bellevue_Prep.RData"))
}
```
